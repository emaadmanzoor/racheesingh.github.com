...
I made use of matplotlib toolkits's Basemap for the background world map. This was really nice to use, with a whole bunch of projections available for your map. I also found a great library called [py_geo_voronoi] (https://github.com/Softbass/py_geo_voronoi) that aids plotting Voronoi diagrams on map-sized plots. Utilizing one of this library's function, I obtained the `Polygon` objects corresponding to each of the polygon in the Voronoi diagram. Then, I processed these polygons to get coordinates corresponding to the world map I had prepared. Polygon by polygon, I plotted them on the map.
